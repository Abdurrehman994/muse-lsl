...
Run this in a separate terminal BEFORE starting record_single.py.
When you're ready to start the video, press Enter here — the marker
is sent instantly and record_single.py will capture it automatically.
...
Workflow:
    ...
    Terminal 2:  python record_single.py 120
    -- when ready --
...
print("=" * 50)
print("Make sure record_single.py is already running.")
print()
